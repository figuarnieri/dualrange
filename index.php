...
<head>
  ...
  <link rel="stylesheet" href="dualrange.css">
</head>
<body>
  ...
  <div class="stage">
    <div class="stage__content">
      ...
      <h2 class="stage__phrase">A javascript library for input range with double values, with only <strong class="stage__phrase-bold">2kb</strong></h2>
    </div>
  </div>
  <div class="content">
...
<span class="code__important">.custom-class</span> <span class="code__tag">.dualrange__min:after</span>, <span class="code__important">.custom-class</span> <span class="code__tag">.dualrange__max:after</span> {
  ...
  <script src="dualrange.js"></script>
  <script>
    (function(){
